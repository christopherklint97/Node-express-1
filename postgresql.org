...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2020-12-09T21:09:40.347937" />
  ...
  <link href="/media/css/fontawesome.css?c696f042" rel="stylesheet">
  ...
  <link rel="shortcut icon" href="/favicon.ico" />
    ...
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?c696f042">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-december-6-2020-2128/">PostgreSQL Weekly News - December  6, 2020</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-12-07 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/check_pgactivity-v25-released-2124/">check_pgactivity v2.5 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-12-01 by Jehan-Guillaume de Rorthais</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/psycopg3-request-for-sponsorship-2125/">psycopg3: request for sponsorship</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-12-01 by Psycopg Development Team</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-november-29-2020-2123/">PostgreSQL Weekly News - November 29, 2020</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-11-30 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/wal-g-0219-released-2126/">WAL-G 0.2.19 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-11-30 by WAL-G</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zp"> Upgrading and updating PostgreSQL</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zo"> Waiting for PostGIS 3.1: GEOS 3.9</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Paul Ramsey</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-12-08</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zn"> Bulk loading into PostgreSQL: Options and comparison</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zm"> What’s the special for logical level of PostgreSQL WAL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;movead li</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-12-08</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zl"> Carole Arnaud</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andreas &#39;ads&#39; Scherbaum</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-12-07</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zi"> 2020 PG Asia Conference Ended Successfully at an Unprecedented Scale!</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;cary huang</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-12-04</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zh"> MVCC in PostgreSQL — 4. Snapshots</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zg"> Random Data</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Zf"> BLOB cleanup in PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hans-Juergen Schoenig</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-12-03</li>
            </ul>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?c696f042"></script>
